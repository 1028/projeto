...
public class TesteCrypto
{
	...
	/*	System.out.println("Mensagem Clara (Hexadecimal):");
		...
		// Gera a chave criptográfica Dummy simétrica e o nome do arquivo onde deverá ser armazenada
		//cdummy.geraChave(new File ("src/Controller/chave.dummy"));
		
		// Gera a cifra Dummy da mensagem dada, com a chave Dummy simétrica dada
		cdummy.geraCifra(bMsgClara, new File ("src/Controller/chave.dummy"));
	...
	//	System.out.print(prn.hexBytesToString(bMsgCifrada));
		...
		cdummy.geraDecifra(bMsgCifrada, new File ("src/Controller/chave.dummy"));
	...
	/*	System.out.println(">>> Cifrando com o algoritmo AES...");
		...
		// Gera a Chave criptográfica AES simétrica e o nome do arquivo onde deverá ser armazenada
	...
	/*	System.out.println(">>> Cifrando com o algoritmo RSA...");
		...
		// Gera as Chaves criptográfica RSA pública e privada e passa os arquivos onde armazenar
