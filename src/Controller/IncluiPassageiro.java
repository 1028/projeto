...
public class IncluiPassageiro extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IncluiPassageiro() {
        super();
	...
	protected void executa(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		passageiro.setDataNascimento(formatador.dataNacional(request.getParameter("nascimento")));
		passageiro.setFormaTrata(Integer.parseInt(request.getParameter("tratamento")));
		passageiro.setTipoPassageiro(Integer.parseInt(request.getParameter("perfil")));
